...
| Principle | Practice |
|-----------|----------|
| Truth over marketing | [architecture.md](architecture.md) and [decisions.md](decisions.md) record real trade-offs |
| Layered depth | Quick start in [README](../README.md); detail in `docs/` |
| Living history | [DEVLOG.md](../DEVLOG.md) and [devlogs/](devlogs/) capture refactors and incidents |
...
Engineering notes are public by design. When something non-obvious happens — a deploy fix, a backend refactor, a ranking quirk — it gets a dated entry under `docs/devlogs/` and a line in [DEVLOG.md](../DEVLOG.md).
...
- [architecture/system-overview.md](architecture/system-overview.md) — where code lives
